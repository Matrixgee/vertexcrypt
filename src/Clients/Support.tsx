...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The minimum investment amount is $1000 for our Starter package.",
    },
    {
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-green-500/20 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="border border-green-500/10 rounded-lg bg-slate-900/60 overflow-hidden"
                  >
                    <button
